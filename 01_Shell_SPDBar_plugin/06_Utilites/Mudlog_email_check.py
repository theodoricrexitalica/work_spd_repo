...
text1 = "Добрый день,<br>Данные ГТИ от вас не поступают. Исправьте пожалуйста." 
name1     = u"<p>Regards," + \
			"<br>Taras Dolgushin" + \
...
Msg.Subject = "Нет передачи данных".decode("utf-8")
Msg.HTMLBody = text1.decode("utf-8")  + text2
Msg.Display()
