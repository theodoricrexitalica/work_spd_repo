...
for well in db.selectedWellList():
	if well.startswith("WS"):
		...
		path_well = path_ws + "\Pad " + pad + "\\" + well_folder + r"\1. DRILLING\Logging\Reservoir Section\Cased Hole Log"
		...
		well_folder = "-".join(well_folder)
		#path_well = path_sva + "\Pad " + pad + "\\" + well_folder
		path_well = path_sva + "\Pad " + pad + "\\" + well_folder + r"\1. DRILLING\Logging\Reservoir Section\Cased Hole Log"
		if os.path.exists(path_well) == False:
			path_well = path_sva + "\Pad " + pad
		webbrowser.open(path_well)
		...
		path_well = path_us + "\Pad " + pad + "\\" + well_folder + r"\1. DRILLING\Logging\Reservoir Section\Cased Hole Log"
		if os.path.exists(path_well) == False:
